...
# 💰 SIMULADOR
    ...
    st.markdown("""
    Finket nació del corazón y la mente de dos estudiantes de Dirección Financiera durante el **Hackathon Fintech 2025**.  
    Su reto era claro: encontrar una solución accesible para enseñar a las personas a **ahorrar con intención**.

    En un mundo donde el gasto impulsivo y la desinformación financiera son comunes, ellas imaginaron una app amigable y educativa, 
